// services.tsx with motion.ts helpers integrated
'use client';
...
import { fadeInUp, fadeIn, fadeScale, staggerContainer } from '@/lib/motion';
  ...
  return (
    <Container className="py-16 space-y-8">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        >
          <motion.div {...fadeIn} className="row-span-2 py-5">
            <Image
          ...
          <motion.div {...fadeIn} className="pr-5">
            <Image
          ...
          <motion.div {...fadeIn} className="pl-5">
            <Image
          ...
          <motion.div
            {...fadeScale}
            className="absolute top-1/2 -translate-y-1/2 left-1/3 bg-primary text-white rounded-2xl px-6 py-8 w-48 space-y-4 shadow-[0_8px_30px_rgba(255,145,0,0.55)]"
          >
        ...
        <motion.div {...fadeInUp} className="space-y-8">
          ...
          <motion.div
            {...fadeInUp}
            className="pt-6 space-x-4 flex items-center"
          >
