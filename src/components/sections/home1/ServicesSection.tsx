  ...
  return (
    <section className="relative py-20 bg-foreground overflow-hidden">
      <div className="absolute top-10 left-10">
        <div className="absolute top-10 left-5 w-40 h-40 rounded-full border border-background opacity-30" />
        <div
          className="w-28 h-28 opacity-30 text-background"
          style={{
            backgroundImage:
      ...
      <div className="absolute bottom-10 right-10">
        <div className="absolute bottom-10 right-5 w-40 h-40 rounded-full border border-background opacity-30" />
        <div
          className="w-36 h-36 opacity-30 text-background"
          style={{
            backgroundImage:
              'radial-gradient(currentColor 2px, transparent 2px)',
            backgroundSize: '14px 14px',
    ...
    ${i % 2 === 1 ? 'md:items-start md:text-left' : 'md:items-end md:text-right'}`}
              >
                ...
                <p className="text-background">{service.desc}</p>
              </div>
