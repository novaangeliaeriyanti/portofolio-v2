      ...
      <div className="mx-auto bg-foreground rounded-2xl p-5 md:p-8 lg:p-12">
        ...
        >
          {industrialCards.map((card, i) => (
            <div
              key={i}
              className="min-w-[300px] max-w-[320px] bg-background border-4 border-background rounded-2xl overflow-hidden shadow-lg snap-start flex-shrink-0 group transition-transform duration-300"
            >
